        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            try {
                ...
                if (code.equals(JPushInterface.getRegistrationID(context)) &&
                        !TextUtils.isEmpty(type) && type.equals("1")) {
                    Intent mIntent = new Intent(); // 车主
                    mIntent.putExtra("MessageContent", "异地登陆");
                    mIntent.setAction("MainActivity");
                    context.sendBroadcast(mIntent);
                } else if (code.equals(JPushInterface.getRegistrationID(context)) &&
                        !TextUtils.isEmpty(type) && type.equals("2")) {
                    Intent mIntent = new Intent(); // 司机
                    mIntent.putExtra("MessageContent", "异地登陆");
                    mIntent.setAction("DriverMainActivity");
                    context.sendBroadcast(mIntent);
                }
            ...
            try {
                ...
                if (code.equals("1003")) {
                    ...
                    i = new Intent(context, DriverMainActivity.class);
                    i.putExtras(bundle);
                    i.putExtra("ts", "推送");
                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    context.startActivity(i);
